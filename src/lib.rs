...
pub use security::{
    ...
    find_wifi_password, link_did_change_notification,
    link_quality_did_change_notification, link_quality_notification_rssi_key,
    link_quality_notification_transmit_rate_key, merge_networks,
    mode_did_change_notification, power_did_change_notification,
    scan_cache_did_update_notification, set_wifi_eap_identity,
    set_wifi_eap_username_and_password, set_wifi_password,
    ssid_did_change_notification, Authorization, ChannelBand, ChannelWidth,
